# 实验 09: Simple Conformal Prediction for Win Rate Estimation
...
| **RMSE** | 0.3863 | 概率预测精度 |
| **ECE** | 0.0079 | 校准误差 |
| **Coverage Rate** | 0.8996 | 期望: 0.9 (1-α) |
| **Avg. Interval Width** | 0.8714 | 置信区间宽度 |
| **Bandwidth** | ±0.0006 | 置信带宽度 |
...
| **Conformal** | **0.8655** | **0.3863** | **0.0079** | **0.8996** | **0.8714** | **Confidence interval** |
