...
class MLPWeibullDelay(BaseMLP):
    """
    MLP with Weibull delay modeling.
    Used for: FDAM (Flexible Distribution Approach with online label correction)

    Outputs:
    - logits: conversion probability
    - log_k: log of Weibull shape parameter k
    - log_lamb: log of Weibull scale parameter lambda
    """
...
def get_model(name: str, **kwargs) -> nn.Module:
    ...
    models = {
        ...
        "MLP_WEIBULL_DELAY": MLPWeibullDelay,
        "MLP_tn_dp": MLPTnDp,
        "MLP_dp": MLPDp,
