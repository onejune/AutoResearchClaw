...
class DataConfig:
    """Data configuration"""
    data_path: str = "/mnt/data/oss_wanjun/pai_work/open_research/dataset/criteo_dataset/data.txt"
    output_dir: str = "/mnt/workspace/git_project/AutoResearchClaw/cvr-delayed-feedback-kdd2026/results/experiment_v2"
...
class Config:
    ...
    methods: List[str] = field(default_factory=lambda: [
        "Vanilla", "FNW", "FNC", "DFM",
        "DEFER", "ES-DFM", "DEFUSE", "Bi-DEFUSE", "FDAM"
    ])
